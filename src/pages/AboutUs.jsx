  ...
  <div>
    <div className="bg-gray-100/80 text-gray-800 justify-center items-center">
      ...
      >
        ...
        />
        <h1 className="title-about absolute">About LwithC</h1>
      </motion.div>
      ...
      <div className="relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24 space-y-16">
          ...
          >
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-blue-600 mb-4">ミッション Mission</h2>
            <p className="leading-relaxed text-base sm:text-lg lg:text-xl mb-6 opacity-90 max-w-3xl">
              オンライン塾を通じて、学生一人ひとりに最適な学習計画と柔軟な環境を提供します。
              AIと講師による個別指導・面談で、多方面の目標達成のためにストレスフリーなサポートし、生徒の未来を切り拓きます。
            </p>
            <img
              src="/"
          ...
          <motion.section
            ...
            className="bg-white bg-opacity-80 p-6 sm:p-8 lg:p-12 rounded-lg shadow-xl"
          >
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-blue-600 mb-4">私たちのビジョン</h2>
            <p className="leading-relaxed text-base sm:text-lg lg:text-xl mb-6 opacity-90 max-w-3xl">
              24時間、相談や質問可能なプラットフォームを構築し、
              いつでもどこでも、スマホ1台でフルに学べる新しい塾の形を実現します。全ての生徒に自律的、且つ、個々のペースを重視した学びと成長の機会を届けます！
            </p>
            <img
